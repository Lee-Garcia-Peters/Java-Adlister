    ...
    <div class="container">
        ...
        <form action="/update" method="POST">
            <div class="form-group">
                ...
                <input id="updateName" name="updateName" class="form-control" type="text" value="${sessionScope.user.username}">
            </div>
            <div class="form-group">
                <label for="updateEmail">Edit Email: </label>
                <input id="updateEmail" name="updateEmail" class="form-control" type="text" value="${sessionScope.user.email}">
            </div>
            <div class="form-group">
